...
export const TransactionState = ({ children }) => {
    ...
    const addTransaction = (typeId, comment) => dispatch({ type: ADD_TRANSACTION, typeId, comment });

    const updateTransaction = (id, typeId, comment) => dispatch({ type: UPDATE_TRANSACTION, id, typeId, comment });
